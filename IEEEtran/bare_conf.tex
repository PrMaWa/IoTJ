...
format \texttt{\small{\$(variable)}}, see Example~\ref{FallRules}. In addition, arithmetic operations can be 
done in the definition of the variable values. Let us see how using them in the fall example. To 
define the acceleration behaviour during a fall one variable is defined: \texttt{\small{Base}}, that it will be 
the acceleration of a person in a stationary position.
...
\begin{itemize}
  ...
  \item $\omega_{x}, \omega_{y}, \omega_{z} \rightarrow$ represent the angular velocity in X, Y and Z direction respectively. The value's unit is degree per second (dps).
\end{itemize}
